    ...
    <>
      ...
      <div className="flex items-center justify-center m-4">
        <div className="flex flex-col items-center justify-center w-[500px] h-[612px] shadow-xl rounded-xl m-4 p-4">
          <div className="text-3xl font-bold text-center relative -left-12">Contact Form</div>
          <div className="w-[400px] h-[450px] flex flex-col items-center justify-center">
            <form>
              ...
              <div className="m-4">
                ...
                <textarea
                  className="form-control w-full px-3 py-1.5 text-sm font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0"
                  rows="3"
                ></textarea>
              </div>
              <button
                type="submit"
                className="text-center p-3 text-white text-sm font-semibold bg-[#057D99] w-full h-[48px] border rounded-[5px]"
              >
                Submit
              </button>
            </form>
