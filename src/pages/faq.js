  ...
  return (
    <>
      ...
      <div className="flex items-center justify-center">
        <div className="grid grid-col md:grid-cols-2 gap-5 mt-6 md:mt-10">
          <div className="flex flex-col w-[395px] md:w-[500px] h-[253px] md:h-[215px] rounded-xl bg-[#ffffff] shadow-xl">
            <div className="h-[61px] bg-[#057d99] rounded-t-md p-4 font-primaryBold text-white text-lg">
              What is Monnay finance?
            </div>
            <div className="w-[343px] md:w-[428px] h-[130px] md:h-[104px] font-primarySemibold text-base my-4 mx-10">
          ...
          <div className="flex flex-col w-[395px] md:w-[500px] h-[253px] md:h-[215px] rounded-xl bg-[#ffffff] shadow-xl">
            ...
            <div className="w-[343px] md:w-[428px] h-[104px] md:h-[78px] font-primarySemibold text-base my-4 mx-10">
          ...
          <div className="w-[395px] md:w-[500px] h-[384px] md:h-[342px] rounded-xl bg-[#ffffff] shadow-xl">
            <div className="h-[57px] bg-[#057d99] rounded-t-md p-4 font-primaryBold text-white text-lg">
              How do I make a deposit?
            </div>
            <div className="w-[343px] md:w-[428px] h-[260px] md:h-[234px] font-primarySemibold text-base my-4 mx-10">
              ...
              <br />
              <br />
              <ul className="list-disc font-primaryRegular">
          ...
          <div className="flex flex-col w-[395px] md:w-[500px] h-[255px] md:h-[194px]rounded-xl bg-[#ffffff] shadow-xl">
            ...
            <div className="w-[343px] md:w-[428px] h-[104px] md:h-[78px] font-primarySemibold text-base my-6 mx-10">
          ...
          <div className="flex flex-col w-[395px] md:w-[500px] h-[133px] md:h-[128px] rounded-xl bg-[#ffffff] shadow-xl">
            <div className="h-20 md:h-[72px] bg-[#057d99] rounded-t-md p-4 font-primaryBold text-white text-lg">
          ...
          <div className="flex flex-col w-[395px] md:w-[500px] h-[169px] md:h-[162px] rounded-xl bg-[#ffffff] shadow-xl relative md:bottom-36">
            ...
            <div className="w-[343px] md:w-[428px] h-[52px] font-primarySemibold text-base my-4 mx-10">
          ...
          <div className="flex flex-col w-[395px] md:w-[500px] h-[166px] md:h-[162px] rounded-xl bg-[#ffffff] shadow-xl relative md:bottom-36 mb-4 md:mb-0">
            ...
            <div className="w-[343px] md:w-[428px] h-[78px] md:h-[52px] font-primarySemibold text-base my-4 mx-10">
